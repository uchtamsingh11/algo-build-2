        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mt-4">
                For information about refunds and cancellations, please refer to our <Link href="/refund" className="text-blue-400 hover:text-blue-300">Refund and Cancellation Policy</Link>.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300">
                Our platform may use a virtual currency called "Z Coins" for certain transactions within the Services. Z Coins have no real-world monetary value and cannot be exchanged for cash or other value outside of our Services. The purchase and use of Z Coins are subject to our <Link href="/refund" className="text-blue-400 hover:text-blue-300">Refund and Cancellation Policy</Link>.
              </p>
            </section>
